...
```{r Your twenty eighth Code Chunk, eval=FALSE, include=FALSE}
...
The customer facing dashboard is on real-time bases where it visualizes the customer data verses other customer data to show the goal to be attained or to guide for future decisions making.
