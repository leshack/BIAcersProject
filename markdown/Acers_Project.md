...
- [Preprocessing and Data
  ...
  - [Heatmap of “missingness” broken down by
    “Age”](#heatmap-of-missingness-broken-down-by-age)
...
- [Training Models](#training-models)
  ...
  - [Model Performance and
    Comparison](#model-performance-and-comparison)
...
- [Save and Load your Model](#save-and-load-your-model)
  - [Making prediction with the
    model](#making-prediction-with-the-model)
  - [Make predictions using the model through a
    function](#make-predictions-using-the-model-through-a-function)
...
`Measures of Relationship` quantify associations between variables. The
Pearson correlation coefficient assesses linear relationships,
covariance measures changes together, and the slope of the regression
line indicates the strength of a linear relationship. R-squared explains
the variance in the dependent variable, and rank correlation
coefficients assess monotonic relationships. These measures aid in
understanding the extent and nature of connections in data analysis
...
Plumber API in R facilitates the creation of web APIs, enabling seamless
integration of R code for data processing and analysis. It transforms R
scripts into interactive and accessible web services, enhancing
collaboration and data-driven decision-making.

`NB` because we we wanted to execute the plumber API in our md we had
run the Plumber API in a separate R process, allowing our R Markdown
document to continue executing by using the future package.The on.exit()
block is used to stop the Plumber API after all the code chunks have
been executed
